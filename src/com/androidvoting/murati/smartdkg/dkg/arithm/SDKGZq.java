...
import com.androidvoting.murati.smartdkg.exceptions.SDKGNoPrimeNumberException;
...
public class SDKGZq {
	...
	public SDKGZqElement fromString(String value) {
		return new SDKGZqElement(q, new BigInteger(value));
	}
