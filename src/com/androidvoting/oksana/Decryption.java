...
//		return true;
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	ArrayList<SDKGZqElement> getValidPartialDecryptions(DecryptionSharesOfVote shares)
			throws NoSuchAlgorithmException {
	...
	private SDKGZqElement decryptVote(EncryptedVote vote)
		...
		ArrayList<SDKGZqElement> validShares = this.getValidPartialDecryptions(allShares);
