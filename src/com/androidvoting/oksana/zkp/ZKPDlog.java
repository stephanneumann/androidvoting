...
public class ZKPDlog {
	private SDKGZqElement g,h,G,H;
	private BigInteger q; 
	
	public ZKPDlog(SDKGZqElement g, SDKGZqElement h, SDKGZqElement G, SDKGZqElement H){
		this.G = G;
		this.H = H;
		this.g = g;
		this.h = h;
	...
	public ZKPDlogProof prove(BigInteger s) throws NoSuchAlgorithmException{		
	...
	public boolean verify(ZKPDlogProof proof) throws NoSuchAlgorithmException{
