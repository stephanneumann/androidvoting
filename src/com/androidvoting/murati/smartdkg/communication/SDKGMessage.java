...
public class SDKGMessage extends Message {
	...
	public static class Type {
		...
		public static final String DECRYPTION_VERIFICATION_COMMITMENT = "Vik Commitment";
		
		public static final String DECRYPTION_SHARE = "Decryption Share";
...
//		extension.useEncryption();
	...
	public boolean isDecryptionShareMessage() {
		return getMessageType().equals(SDKGMessage.Type.DECRYPTION_SHARE);
	}
	
	public boolean isViCommitmentMessage() {
		return getMessageType().equals(SDKGMessage.Type.DECRYPTION_VERIFICATION_COMMITMENT);
	}
